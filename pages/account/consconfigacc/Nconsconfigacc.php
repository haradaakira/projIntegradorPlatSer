...
<html>
    <head>
        <meta charset="utf-8"/>
        <link rel="stylesheet" type="text/css" href="/pages/register/consregister/consregister.css">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item active">
              <a class="nav-link" href="/pages/service/consserv/consserv.php">Serviços</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/pages/account/consconfigacc/Nconsconfigacc.php"><b>Conta</b><span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
        ...
        <div class="container">
            <div class="row">
              <div class="col-12">
                ...
                <form action="consconfigacc.php" method="POST">
                  <div class="container">
                    <h1>Conta</h1>
